...
class AnimaEmbeddingSetup(
    ...
    def setup_model(
        ...
        # TI tokens attach to the Qwen3 word embedding table. Promote it to
        # the embedding dtype (fp32) so the frozen vocab slice and the
        # trainable vectors concatenate cleanly inside the wrapper.
